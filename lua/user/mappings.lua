...
nnoremap('<leader>wf' , '<cmd>lua require("user.helpers").winSelectFloat()<cr>:call repeat#set("<leader>wf")<cr>')
nnoremap('<leader>wh' , '<cmd>lua require("user.helpers").winMoveFloat(0, -1)<cr>:call repeat#set("<leader>wh")<cr>')
nnoremap('<leader>wj' , '<cmd>lua require("user.helpers").winMoveFloat(1, 0)<cr>:call repeat#set("<leader>wj")<cr>')
nnoremap('<leader>wk' , '<cmd>lua require("user.helpers").winMoveFloat(-1, 0)<cr>:call repeat#set("<leader>wk")<cr>')
nnoremap('<leader>wl' , '<cmd>lua require("user.helpers").winMoveFloat(0, 1)<cr>:call repeat#set("<leader>wl")<cr>')
